    ...
    <section class="content">
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- Changer le mot de passe (masqué pour les comptes Google) -->
                <div class="col-md-6 mb-4">
                    <div class="card shadow-sm">
                ...
                <div class="col-md-6 mb-4">
                    <div class="card shadow-sm">
                        <div class="card-header bg-google text-white">
                            <h5 class="mb-0"><i class="fab fa-google"></i> Compte Google</h5>
                        </div>
                        <div class="card-body">
                            <div class="google-account-info">
                                ...
                                <p class="text-muted small">
                                    La gestion de votre mot de passe se fait directement depuis votre compte Google.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="/settings/delete-account">
                <div class="modal-body">
                    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token) ?>">
                    <input type="hidden" name="is_google_user" value="<?= !empty($user->google_id) ? '1' : '0' ?>">
...
[data-theme="dark"] .google-icon-large {
    background: #374151;
}
